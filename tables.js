const atomSectionTable = [
    ...
    { type: "atom", name: "gold" },
    /*
    { type: "section", name: "Alchemical Inversions" },
    { type: "atom", name: "tenebrivex" },
    { type: "atom", name: "antigold" },
    { type: "atom", name: "antisilver" },
    { type: "atom", name: "anticopper" },
    { type: "atom", name: "antiiron" },
    { type: "atom", name: "antitin" },
    { type: "atom", name: "antilead" },
    { type: "atom", name: "yttrium" },
    */
    ...
    { type: "section", name: "Metal Quintessence" },
    { type: "atom", name: "chromium" },
    { type: "section", name: "Neuvolics"},
    { type: "atom", name: "frixon"},
    { type: "atom", name: "zephiron"},
    { type: "atom", name: "gelaron"},
    { type: "atom", name: "hestium"},
    { type: "atom", name: "azulum"},
    { type: "atom", name: "taceum"},
    { type: "atom", name: "mitrum"},
    { type: "atom", name: "iridium"},
